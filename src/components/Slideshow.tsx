...
export default function Slideshow(props: SlideshowProps) {
    ...
    return (
        <>
            ...
            <div ref={props.sref} className="bg-slate-800 w-full lg:h-2/3 xl:h-1/2 md:h-2/3 sm:h-2/3 w-full flex flex-col justify-center p-5 gap-5">
