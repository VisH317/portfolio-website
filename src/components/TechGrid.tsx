    ...
    return (
        ...
        <div className="grid grid-flow-row-dense place-content-center place-items-center lg:grid-cols-3 xl:grid-cols-4 place-items-center md:grid-cols-4 m-auto sm:grid-cols-2 gap-5 w-full">
            <TechGridItem grow={false} hidden={false} image="react-1.svg">
                ...
                <p className="text-lg text-center md:text-sm font-normal bg-gradient-to-r from-slate-200 to-slate-400 text-transparent bg-clip-text">{"Experience: 5 years\nRelated Libraries: Redux, Axios, Material UI"}</p>
            </TechGridItem>
            <TechGridItem grow={false} hidden={false} image="C++.png">
                ...
                <hr className="w-[60%] h-1 mx-auto my-2 bg-gray-100 border-0 rounded md:my-2 dark:bg-slate-500"/>
                <p className="text-lg text-center md:text-sm font-normal bg-gradient-to-r from-slate-200 to-slate-400 text-transparent bg-clip-text">{"Experience: 2 years\nRelated Libraries: LLVM, VEX, Multithreading"}</p>
            </TechGridItem>
            ...
            <TechGridItem grow={false} hidden={false} image="js.png">
                ...
                <hr className="w-[60%] h-1 mx-auto my-2 bg-gray-100 border-0 rounded md:my-2 dark:bg-slate-500"/>
                <p className="text-lg text-center md:text-sm font-normal bg-gradient-to-r from-slate-200 to-slate-400 text-transparent bg-clip-text">{"Experience: 7 years\nRelated Libraries: Express, MongoDB, Passport, Svelte, Next.js, Browser API"}</p>
            </TechGridItem>
            <TechGridItem grow={false} hidden={true} image="next.svg">
                <p className="text-3xl font-semibold bg-gradient-to-r from-purple-200 to-purple-400 text-transparent bg-clip-text">Next.js</p>
                <hr className="w-[60%] h-1 mx-auto my-2 bg-gray-100 border-0 rounded md:my-2 dark:bg-slate-500"/>
            ...
            <TechGridItem grow={false} hidden={false} image="pytorch.png">
                ...
                <hr className="w-[60%] h-1 mx-auto my-2 bg-gray-100 border-0 rounded md:my-2 dark:bg-slate-500"/>
                <p className="text-lg md:text-sm text-center font-normal bg-gradient-to-r from-slate-200 to-slate-400 text-transparent bg-clip-text">{"Experience: 5 years\nRelated Libraries: Pandas, PyTorch, Scikit-Learn, HuggingFace"}</p>
            </TechGridItem>
        </div>
        </div>
    )
