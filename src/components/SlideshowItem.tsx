...
export default function SlideshowItem(props: SlideshowItemProps) {
    ...
    return (
        <div className={`lg:w-10/12 md:w-1/2 sm:w-2/3 flex justify-start items-center h-5/6 rounded-2xl bg-slate-600 duration-300 group relative hover:shadow-2xl`}>
