...
export default function Landing() {
    return (
        <div className='md:container md:mx-auto w-full h-2/3 bg-purple-700 flex items-center justify-center flex-col gap-5'>
            {/* <div className="bg-purple-100 p-5 rounded-3xl flex items-center justify-center"> */}
            <p className='text-5xl text-white font-bold'>Hello! I'm Vishrut</p>
            {/* </div> */}
            <div className="w-2/5">
            ...
            <div className="flex flex-row gap-2.5">
                <input type='email' className="form-input rounded-lg border-transparent w-48 focus:w-80 duration-300 hover:drop-shadow-lg" placeholder="Email:"></input>
